...
We obtained the species tree from muti-copy gene family trees using ASTRAL-Pro2 v1.15.1.3 [1] by optimizing the objective function of ASTRAL-Pro [2].
...
1. In terminal, `cd` into the downloaded directory and run `make`.
  ...
  - If you see "error" when running `make`, please try `make astral-pro` instead and file a bug report.
