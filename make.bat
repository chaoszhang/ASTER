...
g++ -std=gnu++11 -O2 -pthread -static -static-libgcc -static-libstdc++ src/dstar-branch.cpp -o exe/dstar-branch.exe
g++ -std=gnu++11 -O2 -static -static-libgcc -static-libstdc++ src/dstar-branch-merge-diag.cpp -o exe/dstar-branch-merge-diag.exe
